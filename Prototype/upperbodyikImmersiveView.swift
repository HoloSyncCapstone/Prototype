...
//    
//    // Animation data
//    @State private var skeletonFrames: [RealDataSkeletonFrame] = []
...
//        for (start, end) in RealDataSkeletonFrame.boneConnections {
...
//        print("🤖 Solving IK...")
//        skeletonFrames = RealDataAnimationBuilder.buildTimeline(
...
//    private func updateSkeleton(frame: RealDataSkeletonFrame) {
//        // Update root marker
...
//    }
//    
//    private func interpolateSkeletonFrame(at time: TimeInterval) -> RealDataSkeletonFrame? {
